...
import { Badge, Button, Card, CheckboxField, Input, LoadingState, PageHeader, SectionHeader, Select, StatCard } from '../components/ui'
...
const Configuracoes: React.FC = () => {
  ...
  if (loading) {
    return (
      <Card className="ui-screen-narrow p-6">
        <LoadingState
    ...
    <div className="ui-screen">
      ...
      <div className="grid gap-4 xl:grid-cols-[1.3fr_1fr]">
        <section className="ui-spotlight-card">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-2xl space-y-3">
              <p className="ui-spotlight-eyebrow">Central de operacao</p>
              <h2 className="ui-spotlight-title">Tudo o que sustenta a loja em uma tela mais clara.</h2>
              <p className="ui-spotlight-copy">
                Identidade, dispositivos, delivery e regras comerciais ficam organizados para voce ajustar a operacao sem perder contexto.
              </p>
              <div className="flex flex-wrap gap-2">
                <Badge variant={deliveryIntegrationEnabled ? 'success' : 'neutral'}>
                  Delivery {deliveryIntegrationEnabled ? 'automatico' : 'manual'}
                </Badge>
                <Badge variant={logoUrl ? 'info' : 'neutral'}>{logoUrl ? 'Logo pronta' : 'Sem logo'}</Badge>
                <Badge variant="neutral">{configuredDeliveryRules} bairros configurados</Badge>
              </div>
            </div>
            <div className="min-w-[15rem] space-y-2">
              <p className="ui-spotlight-eyebrow">Status atual</p>
              <p className="ui-spotlight-value">{theme === 'green' ? 'Verde' : theme === 'blue' ? 'Azul' : 'Creme'}</p>
              <p className="text-sm text-slate-600">Tema ativo com preferencias prontas para salvar ou revisar.</p>
            </div>
          </div>
        </section>
        ...
        <section className="ui-spotlight-card ui-spotlight-card-muted">
          <div className="space-y-4">
            <div>
              <p className="ui-spotlight-eyebrow">Resumo rapido</p>
              <h2 className="ui-spotlight-title">Pontos que mais mudam o dia a dia</h2>
            </div>
            <div className="ui-micro-grid">
              <article className="ui-micro-card">
                <p className="ui-micro-label">Catalogo</p>
                <p className="ui-micro-value">{categories.length}</p>
                <p className="ui-micro-copy">Categorias visiveis no PDV.</p>
              </article>
              <article className="ui-micro-card">
                <p className="ui-micro-label">Usuarios</p>
                <p className="ui-micro-value">{users.length}</p>
                <p className="ui-micro-copy">Perfis cadastrados no sistema.</p>
              </article>
              <article className="ui-micro-card">
                <p className="ui-micro-label">Entrega</p>
                <p className="ui-micro-value">{configuredDeliveryRules}</p>
                <p className="ui-micro-copy">Regras locais de taxa ativas.</p>
              </article>
              <article className="ui-micro-card">
                <p className="ui-micro-label">Acesso</p>
                <p className="ui-micro-value">{canManageUsers ? 'Admin' : 'Restrito'}</p>
                <p className="ui-micro-copy">Nivel de gestao nesta sessao.</p>
              </article>
            </div>
          </div>
        </section>
      ...
      <Card className="space-y-4 p-5">
        ...
        <div className="ui-inline-card">
          ...
          <div className="rounded-2xl border border-brand-100/80 bg-white/80 p-3">
            {logoUrl ? (
      ...
      <Card className="space-y-4 p-5">
        ...
        />
        <CheckboxField
          label="Tocar sinal quando chegar novo pedido de delivery"
      ...
      <Card className="space-y-4 p-5">
        <SectionHeader
          title="Impressora e Balanca"
          description="Conecte o agente local, escolha a impressora e configure a leitura da balanca."
        />
        ...
        <CheckboxField
          label="Imprimir comanda automaticamente apos a venda"
          checked={autoPrintReceipt}
          onChange={(event) => setAutoPrintReceipt(event.target.checked)}
        />
        <CheckboxField
          label="Imprimir pedido automaticamente na cozinha"
          checked={autoPrintKitchen}
          onChange={(event) => setAutoPrintKitchen(event.target.checked)}
        />
        ...
        <CheckboxField
          label="Balanca habilitada"
          checked={scaleEnabled}
          onChange={(event) => setScaleEnabled(event.target.checked)}
        />
      ...
      <Card className="space-y-4 p-5">
        <SectionHeader
          title="Fidelidade"
          description="Defina a regra de pontos, valor de resgate e minimo para uso em compras."
        />
      ...
      <Card className="space-y-4 p-5">
        <SectionHeader
          title="Taxas de cartao"
          description="Registre o custo de PIX, credito e debito para refletir o liquido nos relatorios."
        />
        <div className="space-y-1">
      ...
      <Card className="space-y-4 p-5">
        <SectionHeader
          ...
          description="Configure a taxa padrao e personalize bairros com regras proprias."
        />
        <input
      ...
      <Card className="space-y-4 p-5">
        <SectionHeader
          ...
          description="Ative a integracao automatica e mantenha os dados necessarios para despacho."
          meta={<Badge variant={deliveryIntegrationEnabled ? 'success' : 'neutral'}>{deliveryIntegrationEnabled ? 'Integracao ativa' : 'Integracao inativa'}</Badge>}
        />
        <CheckboxField
          label="Enviar pedidos delivery automaticamente"
        ...
        <CheckboxField
          label="Habilitar retorno dinamico"
      ...
      <Card className="space-y-4 p-5 lg:col-span-2">
        <SectionHeader
          title="Imagens das categorias (PDV)"
          description="Selecione a categoria e envie uma imagem para deixar o catalogo mais visual."
        />
      ...
      <Card className="space-y-4 p-5 lg:col-span-2">
        <SectionHeader
          ...
          description="Defina o preco base da categoria e aplique o mesmo valor aos produtos quando fizer sentido."
      ...
      {canManageUsers ? (
        <Card className="space-y-4 p-5 lg:col-span-2">
          <SectionHeader
            ...
            description="Cadastre login e senha, depois vincule os perfis de acesso de cada usuario."
            meta={
              <button
                type="button"
              ...
              <div className="mt-4 grid gap-3">
                ...
                <div className="grid gap-2 sm:grid-cols-2">
                  ...
                  <CheckboxField
                    ...
                    checked={userIsStaff}
                    onChange={(event) => setUserIsStaff(event.target.checked)}
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid gap-2">
                    {roles.map((role) => (
                      <CheckboxField
                        key={role.id}
                        containerClassName="rounded-lg border border-brand-100 px-3 py-2"
                        checked={userRoleIds.includes(role.id)}
                        onChange={() => toggleUserRole(role.id)}
                        label={<strong className="block text-slate-800">{role.name}</strong>}
                        description={role.permission_codes.join(', ')}
                      />
                    ))}
                  </div>
                </div>
      ...
      <Card className="space-y-4 p-5" tone="danger">
        <SectionHeader
          title="Area de Perigo"
          description="Cuidado: as acoes abaixo sao irreversiveis."
        />
        <button
      ...
      <Card className="space-y-4 p-5">
        <SectionHeader
          title="Acoes do sistema"
          description="Use estes atalhos para persistir alteracoes ou recarregar os dados vindos do servidor."
        />
