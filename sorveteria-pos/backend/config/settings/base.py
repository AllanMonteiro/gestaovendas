...
ORDER_ALERT_ENABLED = get_bool_env('ORDER_ALERT_ENABLED', default=True)
ORDER_ALERT_PROVIDER = get_env('ORDER_ALERT_PROVIDER', default='whatsapp_cloud') or 'whatsapp_cloud'
ORDER_ALERT_COMPANY_PHONE = get_env('ORDER_ALERT_COMPANY_PHONE', 'COMPANY_WHATSAPP_NUMBER', default='') or ''
ORDER_ALERT_PANEL_BASE_URL = get_env('ORDER_ALERT_PANEL_BASE_URL', 'PANEL_BASE_URL', 'FRONTEND_BASE_URL', default='') or ''
