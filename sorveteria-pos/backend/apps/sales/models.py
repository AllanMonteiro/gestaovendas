...
class StoreConfig(models.Model):
    ...
    public_menu_url = models.TextField(null=True, blank=True)
    ...
    pix_fee_pct = models.DecimalField(max_digits=6, decimal_places=2, default=0)
    card_fee_credit_pct = models.DecimalField(max_digits=6, decimal_places=2, default=0)
    card_fee_debit_pct = models.DecimalField(max_digits=6, decimal_places=2, default=0)
